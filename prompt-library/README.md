...
- Ask quiz questions ONE AT A TIME and wait for my answer before revealing it
...
notes.md
- Detailed mini-tutorial of everything covered
- Include key concepts, steps, commands, and any errors/fixes
